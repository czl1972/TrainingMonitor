...
!function ($) {
    ...
    !function ($) {
        ...
        var MorrisCharts2 = function () { };

        //creates Stacked chart
        MorrisCharts2.prototype.createStackedChart = function (element, data, xkey, ykeys, labels, lineColors) {
                Morris.Bar({
                    element: element,
                    data: data,
                    xkey: xkey,
            ...
            MorrisCharts2.prototype.init = function () {
                ...
                this.createStackedChart('morris-bar-stacked2', $stckedData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#6ad9c3', '#9aa1f2', '#ebeff2']);
            },
            //init
            $.MorrisCharts2 = new MorrisCharts2, $.MorrisCharts2.Constructor = MorrisCharts2
    }(window.jQuery),
